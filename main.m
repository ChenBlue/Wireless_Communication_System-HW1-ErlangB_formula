% Run the largeErlangRho function to derive total traffic by required 
% parameters and use the matrix rho_ans to store all values.
...
% Plot the relation of blocking rate and channel number by line chart
...
title('Total offered traffic load for channel number 1~20')
...
title('Total offered traffic load for channel number 200~220')
xlabel('Channel Number')
ylabel('Total offer traffic load (Erlangs)')
p2(1).Marker = '.'
p2(2).Marker = '.';
